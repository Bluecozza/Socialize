...
(1087, 'find_friends_nearby', 'Find friends nearby', 'العثور على الأصدقاء في مكان قريب', 'Vind vrienden in de buurt', 'Trouver des amis à proximité', 'Freunde in der Nähe finden', 'Trova amici nelle vicinanze', 'Encontre amigos nas proximidades', 'Найти друзей поблизости', 'Encuentra amigos cercanos', 'Yakınlarda arkadaş bul'),
